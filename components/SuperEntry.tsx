...
export default function SuperEntry({ onSubmit, placeholder = 'What would you like to accomplish today?' }: SuperEntryProps) {
  ...
  const examplePrompts = [
    {
      icon: TrendingUp,
      title: 'Optimize Dove Campaign ROI',
      text: 'Analyze Dove Body Wash summer campaign performance across TV and digital, suggest media mix optimizations to improve ROAS from 8.2x to 10x',
      color: 'from-emerald-500 to-green-600',
      category: 'Performance',
    },
    {
      icon: Users,
      title: 'Premium Brand Buyer Segments',
      text: 'Identify premium buyers for Johnnie Walker who engage across retail media networks and create exclusive VIP retention campaigns',
      color: 'from-blue-500 to-indigo-600',
      category: 'Segmentation',
    },
    {
      icon: Sparkles,
      title: 'Ben & Jerry\'s Launch Assets',
      text: 'Create complete campaign package for new flavor launch: TikTok video scripts, Instagram Reels concepts, and influencer partnership briefs',
      color: 'from-purple-500 to-pink-600',
      category: 'Creative',
    },
    {
      icon: BarChart3,
      title: 'Multi-Brand Attribution Model',
      text: 'Analyze brand lift attribution across our CPG portfolio spanning TV, social, retail media, and programmatic channels',
      color: 'from-orange-500 to-red-600',
      category: 'Analytics',
    },
    {
      icon: Mail,
      title: 'Health-Conscious Consumer Flow',
      text: 'Design CRM nurture sequence targeting health-conscious shoppers with recipe content and product trial offers for wellness brands',
      color: 'from-cyan-500 to-blue-600',
      category: 'Email',
    },
    {
      icon: Zap,
      title: 'Retail Media Automation',
      text: 'Set up automated bidding and promotional triggers across Amazon, Walmart, and Instacart retail media networks based on inventory and sales velocity',
