...
export default function InsightsSection() {
  ...
  const topCampaigns = [
    { name: 'Dove Body Wash Summer Launch', conversions: 28400, spend: 420000, roas: 8.2, trend: 'up' },
    { name: 'Johnnie Walker Holiday Campaign', conversions: 19600, spend: 680000, roas: 6.4, trend: 'up' },
    { name: 'Ben & Jerry\'s New Flavor Promo', conversions: 34200, spend: 280000, roas: 9.1, trend: 'up' },
    { name: 'Magnum Ice Cream Digital Push', conversions: 15800, spend: 340000, roas: 4.3, trend: 'down' },
    { name: 'Hellmann\'s Recipe Integration', conversions: 22100, spend: 195000, roas: 7.8, trend: 'up' },
  ];

  const audienceSegments = [
    { name: 'Premium Brand Buyers', size: 145000, engagement: 82, revenue: 2840000, color: 'bg-green-500' },
    { name: 'Brand Loyalists (90-Day)', size: 428000, engagement: 71, revenue: 1680000, color: 'bg-blue-500' },
    { name: 'Deal Seekers', size: 892000, engagement: 54, revenue: 980000, color: 'bg-purple-500' },
    { name: 'Health-Conscious Shoppers', size: 267000, engagement: 68, revenue: 1120000, color: 'bg-cyan-500' },
    { name: 'At-Risk Switchers', size: 183000, engagement: 28, revenue: 340000, color: 'bg-orange-500' },
  ];
